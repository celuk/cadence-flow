...
set CAPTABLE_PATH "data/tech/captable"
...
#set STD_LEF $TSMCHOME_STD_LEF
#set STD_LEF $EDITED_STD_LEF
#set IO_LEF $TSMCHOME_IO_LEF
#set BONDPAD_LEF $TSMCHOME_BONDPAD_LEF

#set STD_TIMING_LIB_PATH $TSMCHOME_STD_TIMING_LIB_PATH
#set IO_TIMING_LIB_PATH $TSMCHOME_IO_TIMING_LIB_PATH

#set GDSOUT_MAP_FILE $TSMCHOME_GDSOUT_MAP_FILE
# set GDSOUT_MAP_FILE $VIRTUOSO_GDSOUT_MAP_FILE

#set QRC_TECH_FILE "${QRC_TECH_PATH}/qrcTechFile"

#set PARASITICS_MAX_CAPTABLE $TSMCHOME_PARASITICS_MAX_CAPTABLE
#set PARASITICS_NOM_CAPTABLE $TSMCHOME_PARASITICS_NOM_CAPTABLE
#set PARASITICS_MIN_CAPTABLE $TSMCHOME_PARASITICS_MIN_CAPTABLE

#set GDS_FILES_TO_MERGE [list \
#${TSMCHOME_STD_GDS} \
#${TSMCHOME_IO_GDS} \
#${TSMCHOME_BONDPAD_GDS} \
